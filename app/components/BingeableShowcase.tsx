...
const BingeableShowcase = () => {
  ...
  return (
    <div ref={wrapperRef} className="bingeable-wrapper w-full  lg:h-dvh lg:w-max  ">
      <div ref={sliderRef} className="bingeable-slider flex flex-col justify-center items-center w-full h-full lg:h-dvh lg:flex-row  lg:w-max gap-20 lg:gap-3">
                ...
                <div className="lg:w-[40%]  slide-1-right flex flex-col justify-center items-center  lg:-translate-x-12  px-12  lg:px-0">
                    ...
                    <div className="flex flex-row gap-6 lg:gap-4 xl:gap-14 -translate-y-12 text-sand  ">
                        <div className="count-up flex flex-row gap-3 opacity-0 justify-center items-center">
                            <Download size={26} />
                          <div className="flex flex-col text-sm font-medium text-center"><span className='text-2xl lg:text-3xl xl:text-5xl font-bold' ref={downloadsRef}>0</span> downloads</div>
                        </div>
                        <div className="count-up flex flex-row gap-3 opacity-0 justify-center items-center">
                            <FilePen size={26} />
                          <div className="flex flex-col   text-sm font-medium text-center"><span className='text-2xl lg:text-3xl xl:text-5xl font-bold' ref={signUpRef}>0</span> user sign-ups</div>
                        </div>
                        <div className="count-up flex flex-row gap-3 opacity-0 justify-center items-center">
                            <Star size={26} />
                          <div className="flex flex-col  text-sm font-medium text-center"><span className='text-2xl lg:text-3xl xl:text-5xl font-bold' ref={ratingRef}>0</span> avg rating/5</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id='front-end' className="bingeable-element  w-dvw h-full flex flex-col justify-start 2xl:items-center 2xl:justify-center gap-0 text-sand  pt-20 relative ">
            <div className="front-end-title-container flex flex-col justify-center items-center  gap-3 " >
                    ...
                    <p className='front-end-para font-heading   px-8 lg:px-0   text-sand lg:w-[800px]  xl:w-[1100px] font-bold text-2xl pt-2  '>All about the UI and client logic. Take a closer look at how I approached the front end with real production code snippets.</p>
              <LogoScroll   data={frontEndIcons} className='py-3 px-10 '/>
            </div>

            { isDesktop ? (
              <div style={{zIndex:20}} className="2xl:flex   2xl:flex-row  gap-10 pt-10 w-full ">
        ...
        <div id='back-end' className="bingeable-element back-end w-dvw h-full flex flex-col justify-start 2xl:items-center 2xl:justify-center gap-0 text-sand  pt-20 relative">
            <div className="back-end-title-container w-full flex flex-col justify-center items-center gap-3">
                    ...
                    <p className='font-heading back-end-para    px-8 lg:px-0   text-sand lg:w-[800px]  xl:w-[1100px] font-bold text-2xl pt-2  '>A robust backend is needed to support the front end. Here are snippets from my production server code.</p>
        ...
        <div className='bingeable-element challenges h-full pt-10 w-dvw px-8 '>
          <div className="challenges-container flex flex-col justify-center items-center  gap-3 w-full" >
            <div className='challenges-text-container flex flex-col justify-center items-center gap-3'>
              ...
              <p className='challenges-para font-heading w-full lg:w-[1000px] font-bold text-2xl pt-2 text-sand text-left px-8 lg:px-0 '>Here were some of my biggest challenges and takeaways from building this app.</p>
            </div>
        ...
        <div className='challenges-3 w-dvw px-8 h-full'>
          <h2 className='challenges-title text-customBlue font-bold font-heading tracking-[0.3em] uppercase pt-10 hidden lg:flex' >Challenges</h2>
