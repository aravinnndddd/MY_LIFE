...
const IntroSection = () => {
    ...
    const testimonialVideos = [
        {
            ...
            description: "Syam's incredible medical journey through 21 surgeries, kidney transplant, and the determination that led him to the sky"
        },
        {
            id: "pV9OerNwpdk", 
            title: "World Record Breakthrough: 13,000ft Solo Jump",
            description: "The historic moment - youngest amputee solo skydive from 13,000ft without prosthetic leg, certified by International Book of Records"
        },
        {
            id: "9JXt6NK0rZA",
            title: "Sky Beyond Limits: 43,000ft Mission Revealed",
            description: "The future mission targeting three world records from 43,000ft with adaptive wingsuit technology and global partnerships"
        }
    ];
  ...
  return (
    <div className="intro-section w-dvw flex flex-col min-h-dvh items-center relative overflow-hidden pb-[200px]" style={{}}>
        ...
        <div className="flex flex-col items-center w-[90%] max-w-[1200px] pt-[200px] pb-[100px] justify-start">
            ...
            <div className="videos-grid grid grid-cols-1 lg:grid-cols-3 gap-8 w-full">
                ...
                {testimonialVideos.map((video, index) => (
                    <div key={video.id} className="video-container bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/30 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-105">
                        ...
                        <div className="text-center">
                            <a 
                                ...
                                className="inline-flex items-center bg-[#FF6B6B] hover:bg-[#FF5252] text-white font-bold py-2 px-4 rounded-lg transition-all duration-300 transform hover:scale-105"
                            >
            ...
            <div className="mt-16 text-center">
                <p className="text-white/90 text-lg md:text-xl max-w-[800px] leading-relaxed">
                    These testimonials showcase Syam's incredible journey from medical trauma to sky mastery. 
                    Each video tells a part of the story that proves human potential has no ceiling.
                </p>
                
                <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                    <button className="bg-[#FF6B6B] hover:bg-[#FF5252] text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105">
                        Support The Mission
                    </button>
